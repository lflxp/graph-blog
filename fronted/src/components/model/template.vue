  ...
  methods: {
    ...
    submit () {
      if (this.menuConfig.name.length > 0) {
        ...
        var tmp = {
          'key': '/ares/cmdb/template/' + this.menuConfig.group + '/' + this.menuConfig.name,
          'ttl': 1,
    ...
    deleteit () {
      if (this.menuConfig.name.length > 0) {
        var key = '/ares/cmdb/template/' + this.menuConfig.group + '/' + this.menuConfig.name
        console.log(key)
    ...
    deletegroup () {
      if (this.menuConfig.name.length > 0) {
        var tmp = {
          key: '/ares/cmdb/template/' + this.menuConfig.group,
          recursive: true
        }
        console.log(tmp)
    ...
    handleOk () {
      if (this.groupname.length > 0) {
        ...
        var tmp = {
          'key': '/ares/cmdb/template/' + this.menuConfig.name,
          'ttl': 1,
          'value': JSON.stringify(this.menuConfig)
        }
        Utils.setInfo(tmp).then(resp => {
